          ...
          <View className="flex-1 px-6">
            <View className="flex-1 justify-center">
              ...
              <View className="items-center mb-8">
                <View className="bg-gradient-to-br w-11 h-11 from-blue-600 to-purple-600 rounded-2xl items-center justify-center mb-4 shadow-lg">
                  {/* Main Icon */}
                ...
                <Text className="text-lg text-center text-gray-600">
                  We have send a verification code to {emailAddress}
                </Text>
              </View>
              ...
              <View className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-6">
                ...
                <View className="mb-6">
                  ...
                  <View className="flex-row items-center bg-gray-50 rounded-xl px-4 py-2 border border-gray-200">
                    <Ionicons color={"#6B7280"} size={20} name="key-outline" />
                    <TextInput
                      value={code}
        ...
        <View className="flex-1 px-6">
          ...
          <View className="pb-6">
            <Text className="text-center text-gray-500 text-sm">
              Reacy to transform your fitness?
            </Text>
          </View>
        </View>
      </KeyboardAvoidingView>
